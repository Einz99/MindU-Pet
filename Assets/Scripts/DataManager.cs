...
public class DataManager : MonoBehaviour
{
    ...
    private void LoadData()
    {
        ...
        studentId = PlayerPrefs.GetInt(PlayerPrefKeys.StudentID);
        apiUrl = PlayerPrefs.GetString(PlayerPrefKeys.API_URL);  // Fallback URL if not found
        apiUrlSecondary = PlayerPrefs.GetString(PlayerPrefKeys.API_URL_Secondary);  // Fallback secondary API URL
        Debug.Log($"From DataManager:\nRootAPI: {apiUrl}\nAPI: {apiUrlSecondary}\nStudentID: {studentId}");
    }
